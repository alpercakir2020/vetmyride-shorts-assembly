...
const totalDuration =
  timepoints.length > 0 ? Math.max(...timepoints.map((t) => t.timeSeconds)) : 0;
...
console.log(`✓ word-timestamps.json (${timepoints.length} marks, ${totalDuration.toFixed(2)}s)`);
